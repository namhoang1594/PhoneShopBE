...
{
    public abstract class PhoneShopAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PhoneShopAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PhoneShopAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PhoneShopADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PhoneShopADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PhoneShopADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PhoneShopADbContext, Task<T>> func)
        {
            T result;
